...
export declare type Updater<TContext, TEvent extends EventObject> = (context: TContext, event: OmniEventObject<TEvent>, assignActions: Array<AssignAction<TContext, TEvent>>) => TContext;
