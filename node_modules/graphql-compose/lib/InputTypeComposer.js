...
class InputTypeComposer {
  ...
  getFieldTC(fieldName) {
    ...
    if (tc instanceof InputTypeComposer || tc instanceof _EnumTypeComposer.EnumTypeComposer || tc instanceof _ScalarTypeComposer.ScalarTypeComposer) {
      return tc;
    } else {
      throw new Error(`Type ${this.getTypeName()} has invalid field ${fieldName} which is not of an input type.`);
    }
  }
