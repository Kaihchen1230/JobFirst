let dict = {
    'ch': {
        ...
        'Creative arts and design': "创意艺术与设计",
        'Energy and utilities': "能源和公用事业",
        'Engineering and manufacturing': "工程与制造",
        'Environment and agriculture': "环境与农业",
        'Healthcare': "保健",
        'Information technology': "信息技术",
        'Law': "法律",
        'Marketing, advertising and PR': "营销、广告和公关",
        'Media and internet': "媒体和互联网",
        'Property and construction': "土地房产和建筑",
        'Public services and administration': "公共服务和行政",
        'Recruitment and HR': "招聘与人力资源",
        'Retail': "零售业",
        'Sales':"销售",
        'Science and pharmaceuticals': "科学与制药",
        'Social care': "社会关怀",
        ...
        "School City": "学校城市",
        "School Country": "学校国家",
        "Update Your Address": "更新你的地址",
        "Line 1": "第1行",
        "Line 2": "第1行",
        "Enter the first line of the street address": "输入街道地址的第一行",
        "Enter the second line of the street address": "输入街道地址的第二行",
        "City": "市",
        "Update": "更新",
        "Enter the name of the city": "输入城市名称",
        "Enter the postal code": "输入邮政编码",
        "Enter the name of the state": "输入州名称",
        "Add Your Address": "添加你的地址",
        "Beginner": "初学者",
        "Elementary": "初级",
        "Pre-intermediate": "预中间",
        "Intermediate": "中间",
        ...
        "Website": "网站",
        "Open Jobs": "打开工作",
        "Edit Company Information": "编辑公司信息",
    ...
    'es': {
        ...
        "Line 1": "Line 1",
        "Line 2": "Line 2",
        "Enter the first line of the street address": "Enter the first line of the street address",
        "Enter the second line of the street address": "Enter the second line of the street address",
        "City": "City",
        "Update": "Update",
        "Enter the name of the city": "Enter the name of the city",
        "Enter the postal code": "Enter the postal code",
        "Enter the name of the state": "Enter the name of the state",
